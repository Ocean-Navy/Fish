...
const cards = [
  ...
  { label: "Live now", title: "/api/features", body: "Public AI menu with simple boxes, model aliases, route labels, and caps." },
  { label: "Pilot", title: "/api/box/:boxId/run", body: "Run a Fish menu box with server-side prompts, credits, route labels, and receipts." },
...
const endpoints = [
  ...
  { method: "POST", path: "/api/box/:boxId/run", state: "Pilot" },
