...
const cards = [
  ...
  { label: "Live now", title: "/api/support", body: "Create a support or refund ticket without exposing prompts, outputs, keys, or card details." },
  { label: "Crew only", title: "/api/support/export", body: "Export support and refund tickets for operator follow-up." },
