...
Current spend behavior: one request consumes one lane. Fish spends grant credits first, then subscription, prepaid, staking, adjustment, and refund credits. Expired positive credit entries are excluded from reservation and debit availability. Mixed-lane debits are a future accounting upgrade.
